...
VALUES ('admin', 'admin@cineverse.com', '$2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin');
...
-- Seed platforms
INSERT IGNORE INTO platforms (name, logo) VALUES
('Netflix',      '🎬'),
('Amazon Prime', '📺'),
('Apple TV+',    '🍎'),
('Disney+',      '🏰'),
...
-- Seed movies
INSERT IGNORE INTO movies (title, slug, description, director, cast, release_year, duration, rating, rating_count, is_featured, is_trending, status) VALUES
...
-- Seed movie platforms
INSERT IGNORE INTO movie_platforms (movie_id, platform_id, available)
SELECT m.id, p.id,
  CASE
